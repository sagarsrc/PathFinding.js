...
You run Dijkstra pathfinding on a fixed map and capture performance metrics.
...
1. Explore the repo to find the Dijkstra finder and Grid class.
2. Create the **exact same** fixed 15x15 grid as the A* racer. Use this exact wall layout:
...
3. Run Dijkstra (no diagonal movement) on this grid.
4. Capture metrics:
...
Save ALL output files to `/home/sagar/PathFinding.js-fork/docs/experiments/001-demo-artifacts/fleets/fleet-03-algorithm-race/workers/racer-dijkstra/output/` — use absolute paths.
